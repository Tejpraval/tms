  ...
  `}
      style={
        isAlerting
          ...
          : tier === "CRITICAL"
            ? {
              boxShadow: `0 0 ${30 * volatilityIntensity}px rgba(255,0,0,${0.4 * volatilityIntensity
                })`,
            }
            : undefined
      }
    ...
    >
      ...
      <p
        className={`text-sm font-semibold ${predictedNext > score
            ? "text-red-200"
            : predictedNext < score
              ? "text-green-200"
              : "text-white"
    ...
    `}
      ...
      {rolloutInfluencePercent > 0 && (
        <div className="mt-3">
          <p className="text-sm">
            Rollout Influence: {Math.round(rolloutInfluencePercent)}%
          </p>
